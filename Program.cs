...
namespace Tubes2Stima
{
    ...
    class Program
    {
        ...
        static bool checkExist(int target, List<int> result)
        {
        ...
        static void recurseSolve(int curr, int target, ref bool found, Graph path, ref List<int> result)
        {
        ...
        static void recursiveCont(int curr, Graph path, ref List<int> further){
            List<int> neighbor = path.getPath(curr);
            further.Add(curr);
